...
import { loadConfig as apiLoadConfig, saveConfig as apiSaveConfig, clearConfig as apiClearConfig, fetchEmbeddingStatus } from '../api.js';
...
export function clearConfig() {
    ...
    // 重置本地模型字段
    inputs.localTranslate.value = DEFAULTS.localTranslate || 'Qwen/Qwen2.5-1.5B-Instruct';
...
export async function loadConfig() {
    try {
        ...
        if (data.is_configured) setBadge('ready', '✅ 已配置');
