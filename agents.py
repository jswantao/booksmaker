...
PARAGRAPH_TRANSLATOR = Agent(
    ...
    generation_overrides={"temperature": 0.1, "max_tokens": 1500},
...
EPUB_REPLACER = Agent(
    ...
    generation_overrides={"temperature": 0.0, "max_tokens": 4096},
...
KB_BUILDER = Agent(
    ...
    generation_overrides={"temperature": 0.2, "max_tokens": 800},
...
LONG_TRANSLATOR = Agent(
    ...
    generation_overrides={"temperature": 0.15, "max_tokens": 2048},
    post_process=_clean_translation,
